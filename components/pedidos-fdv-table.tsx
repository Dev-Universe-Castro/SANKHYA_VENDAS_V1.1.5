      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Pedidos de Vendas - Força de Vendas</CardTitle>
              <CardDescription>
            ...
            <div className="space-y-4">
              ...
              {pedidoSelecionado.ERRO && (
                <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                  ...
                  <pre className="text-sm text-red-600 whitespace-pre-wrap overflow-auto max-h-96 bg-white p-3 rounded border border-red-300 font-mono">
                    {(() => {
                      let erroFormatado = pedidoSelecionado.ERRO;

                      // If the error is an object, stringify it. Otherwise, use it as is.
                      if (typeof erroFormatado === 'object' && erroFormatado !== null) {
                        return JSON.stringify(erroFormatado, null, 2);
                      }
